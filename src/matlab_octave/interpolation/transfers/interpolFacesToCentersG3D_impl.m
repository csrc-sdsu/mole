function I = interpolFacesToCentersG3D_impl(k, m, n, o, dc, nc)
% PURPOSE
...
% ----------------------------------------------------------------------------
    ...
    if nargin ~= 4 && nargin ~= 6
        error("interpolFacesToCentersG3D:InvalidNumArgs",...
              "interpolFacesToCentersG3D expects 4 or 6 arguments");
    elseif nargin == 4
