...
/*
 * @file utils.h
 * @brief Helpers for sparse operations and Octave analogs
 * @date 2024/10/15
 *
 */
...
public:
  ...
  */
  ...
  /**
  * @brief An analog to the Octave 2D meshgrid operation
  *
  ...
  */  
  ...
  /**
  * @brief An analog to the Octave 3D meshgrid operation
  *
