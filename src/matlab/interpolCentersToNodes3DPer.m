...
function I = interpolCentersToNodes3DPer(k, m, n, o)
...
% centers logical coordinates [1,1.5:m-0.5,m]x[1,1.5:n-0.5,n]x[1,1.5:o-0.5,o]
    ...
    I1 = interpolCentersToFacesD1DPer(k, m);
    I2 = interpolCentersToFacesD1DPer(k, n);
    I3 = interpolCentersToFacesD1DPer(k, o);
