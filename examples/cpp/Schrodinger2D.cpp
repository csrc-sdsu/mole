...
int main() {
    ...
    double A = 0.1;
    // Ensure the initial condition matches the MATLAB function setup
    ...
    std::cout.precision(6);  // Matching the precision from the MATLAB output
    ...
    for (int t = 0; t <= p; ++t) {
        ...
        // Only print for the final time step 
        if (t == p) {
            std::cout << "Final time step " << t << std::endl;
