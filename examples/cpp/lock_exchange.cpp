...
int main() {
  ...
  for (int t = 0; t < iterations; t++) {
    ...
    // Use transpose to match GNU Octave's column-major order during vectorization
    ...
    // -- Corrector Step --
    // Update velocities by adding the pressure gradient, similar to GNU Octave's u
    // = u_s+G(1:u_length, :)*p;
