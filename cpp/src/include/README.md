...
All header files (.h) for the different MOLE v2.0.0 C++ modules
are contain in this directory. MOLE examples and tests have their own
include subdirectories.
Header files contain declarations of the MOLE C++ API, which is
the MOLE collection of functionalities available to MOLE users.
