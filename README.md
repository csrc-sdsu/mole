...
- **Building Documentation**: To build documentation locally, follow our [Documentation Build Guide](https://github.com/csrc-sdsu/mole/blob/master/doc/sphinx/README.md).
